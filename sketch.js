...
var pathImg, carImg, carImg2, obstacle1Img, obstacle2Img;
var gameState = PLAY;
var END = 0;
var PLAY = 1;
...
function preload(){
   ...
   carImg2 = loadAnimation("car2.png");
...
function draw() {
   ...
   if(coneG.isTouching(car)){
      ...
      obstacle1.addAnimation("obstacle1",carImg2);
     }
     
     if(barrierG.isTouching(car)){
       gameState = END;
       obstacle2.velocityY = 0;
       obstacle2.addAnimation("obstacle2",carImg2);
     }
